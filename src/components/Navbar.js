        ...
        <nav className="flex items-center justify-between flex-wrap bg-blue-500 p-6">
            ...
            <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${!navbarShown && 'hidden'}`}>
                    <div className="text-sm lg:flex-grow">
                        ...
                        <NavLink to="/something" className="block mt-4 lg:inline-block text-xl lg:mt-0 text-blue-200 hover:text-white mr-4 ml-4">
                            Something something
                        </NavLink>
                        <NavLink to="" className="block mt-4 lg:inline-block text-xl lg:mt-0 text-blue-200 hover:text-white ml-4">
                            Statistics
                        </NavLink>
                    </div>
            </div>
